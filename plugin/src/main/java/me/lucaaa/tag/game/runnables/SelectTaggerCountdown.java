...
public class SelectTaggerCountdown {
    ...
    public SelectTaggerCountdown(TagGame plugin, Arena arena, List<PlayerData> playersList) {
        this.plugin = plugin;
        this.arena = arena;
        ...
        this.timer = new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (countdown == 0) {
                    ...
                    List<PlayerData> availableTaggers = new ArrayList<>(playersList);
                    // The taggers the arena will start with
                    List<PlayerData> taggers = new ArrayList<>();
