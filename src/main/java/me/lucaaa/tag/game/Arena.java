...
public class Arena implements TagArena {
    ...
    private final ArrayList<Location> waitingAreaSpawns = new ArrayList<>();
    private final ArrayList<Location> arenaAreaSpawns = new ArrayList<>();
    ...
    private final ArrayList<PlayerData> playersList = new ArrayList<>();
    private final ArrayList<PlayerData> taggers = new ArrayList<>();
    ...
    @Override
    public ArrayList<TagPlayer> getTaggers() {
    ...
    public void setInitialTaggers(ArrayList<PlayerData> taggers) {
