...
public interface TagArena {
     ...
     * HIT - Taggers tag players by hitting them with an item.
     * LIMITED_HIT - Same as HIT, but the loser will be the player that has been the tagger for the longest time.
     * TNT - Taggers tag players by throwing TNT (A random player affected by the explosion will be the tagger).
     * LIMITED_TNT - Same as TNT, but the loser will be the player that has been the tagger for the longest time.
     *
